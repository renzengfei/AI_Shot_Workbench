    ...
    return (
        <>
            ...
            <div style={{ 
                ...
                inset: 0, 
                background: `
                    radial-gradient(ellipse 100% 100% at 20% 20%, rgba(160,185,230,0.5) 0%, transparent 50%),
                    radial-gradient(ellipse 100% 100% at 80% 30%, rgba(180,200,240,0.4) 0%, transparent 45%),
                    radial-gradient(ellipse 100% 100% at 70% 70%, rgba(240,200,175,0.45) 0%, transparent 50%),
                    radial-gradient(ellipse 100% 100% at 30% 80%, rgba(200,180,220,0.35) 0%, transparent 45%),
                    radial-gradient(ellipse 80% 80% at 50% 50%, rgba(210,220,240,0.3) 0%, transparent 60%),
